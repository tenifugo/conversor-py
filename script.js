      ...
      .addEventListener('click', function (event) {
          ...
          const data = {
              empresa: {
                  ...
                  arranjoSocietario: document.querySelector('input[name="arranjo"]:checked')?.value || null,
                  compliance: document.querySelector('input[name="compliance"]:checked')?.value || null,
                  complianceOfficer: document.querySelector('input[name="complianceOfficer"]').value,
                  email: document.querySelector('input[name="email"]').value,
                  codigoConduta: document.querySelector('input[name="codigoConduta"]:checked')?.value || null,
                  pldft: document.querySelector('input[name="pldft"]:checked')?.value || null,
                  socios: [],
              },
          };
